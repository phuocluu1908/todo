...
export class InitPostgres1772978929911 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "activity_log" ("id" SERIAL NOT NULL, "action" character varying NOT NULL, "details" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "todoId" integer, CONSTRAINT "PK_067d761e2956b77b14e534fd6f1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "activity_log" ADD CONSTRAINT "FK_3647a8617ad83ca669de19d76ef" FOREIGN KEY ("todoId") REFERENCES "todo"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "activity_log" DROP CONSTRAINT "FK_3647a8617ad83ca669de19d76ef"`);
