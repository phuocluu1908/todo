...
echo "[1/9] Resolving AWS account ID..."
...
echo "[2/9] Deploying/Updating low-cost CloudFormation stack..."
...
echo "[9/9] Refreshing app on EC2 via SSM (pull + restart)..."
